...
jQuery(".inBox").slide({ titCell:".inHd li",trigger:"click",mainCell:".inBd" });
jQuery(".switchBox").slide();
jQuery(".yanzbox").slide();
//
function roll(direction){
	...
	if('r' == direction){
		for(var i=0; i<imgLength; i++){
			...
			img[i].alt = ad[start].alt;
			img[i].title = ad[start].alt;
		}
		position = position + 1;
...
function move(direction){
	...
	// if(direction == 'r'){
	// 	cur = cur + 1;
	// 	img[5].style.left = "750px";
	// 	hide = setInterval("right()", frequency);
	// 	isRunning = 'true';
	// }
	// if(direction == 'l'){
	// 	cur = cur - 1;
	// 	img[5].style.left = "-128px";
	// 	var pos = position - 1;
	// 	if(pos < 0)
	// 		pos = pos + ad.length;
...
function reset(){
	img[0].style.width = "106px";
	img[0].style.height = "79px";
	img[0].style.left = "10px";
	
	img[1].style.width = "133px";
	img[1].style.height = "99px";
	img[1].style.left = "128px";
	
	img[2].style.width = "185px";
	img[2].style.height = "138px";
	img[2].style.left = "281px";
	
	img[3].style.width = "133px";
	img[3].style.height = "99px";
	img[3].style.left = "486px";
	
	img[4].style.width = "106px";
	img[4].style.height = "79px";
	img[4].style.left = "638px";
	
	img[5].style.width = "1px";
	img[5].style.height = "1px";
	img[5].style.left = "-128px";
}
